...
class BasicMAC:
    ...
    def select_actions(self, ep_batch, t_ep, bs=slice(None), test_mode=True):
        # Only select actions for the selected batch elements in bs
        # ep_data: this current episode, each timestep observation
        # t_ep: current timestep
        # bs: used to parallel generate action, no use in here
